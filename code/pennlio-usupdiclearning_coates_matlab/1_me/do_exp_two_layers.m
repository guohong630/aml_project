...
%CIFAR_DIR='/home/pli/1_matlab_codes/Coates_NIPS_2011/Data/cifar-10-batches-mat';
...
fprintf('train = %d\n',numTrainImage);
fprintf('k = %d\n',numBases1);
report_file = [res_DIR method '_' num2str(numTrainImage) '_' num2str(numBases1)  '_report.txt'];
