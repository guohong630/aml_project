...
dataset = 'AR';
data_DIR='../dataset/AR/data_AR';

% dataset = 'AR_ALL';
% data_DIR='../dataset/AR/data_AR_ALL.mat';
% data_DIR='../dataset/AR/data_AR_ALL_DIM_64.mat';
% data_DIR='../dataset/AR/data_AR_ALL_DIM_165.mat';
% dataset = 'AR_disguise';
...
% data_DIR='../dataset/YaleB/data_YaleB_DIM_64.mat';
...
%     save(['Feat/' dataset '_feature_' alg '_' encoder '.mat'], 'testXCs','trainXCs');
% end
