...
num_train = 10; % training size per class
num_test = 5;
...
if holistic
    save(['./res_new/acc_holistic_' dataset '_mycoding_' encoder '_Dict_' dataset_Dict '_' alg], 'result');
else
    save(['./res_new/acc_' dataset '_mycoding_' encoder '_Dict_' dataset_Dict '_' alg], 'result');
end
